...
def _validate_frame_shape(df: pd.DataFrame) -> None:
...
def _validate_incident_ids(incident_ids: pd.Series) -> None:
...
def _validate_required_text_fields(df: pd.DataFrame) -> None:
...
def _validate_severity_rules(df: pd.DataFrame) -> None:
...
def validate_incidents_df(df: pd.DataFrame) -> None:
    ...
    """
    _validate_frame_shape(df)
    _validate_incident_ids(df["incident_id"])
    _validate_required_text_fields(df)
    _validate_severity_rules(df)
